...
const CaptainHome = () => {
    ...
    useEffect(() => {
        if (!captain || !captain._id) {
            console.error("Captain data is not available or captain._id is null");
            return;
        }
        ...
        // Defines a function that retrieves the captain's current location and sends it to the server evry 10 sec
